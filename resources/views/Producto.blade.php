    ...
    <div class="banner_top innerpage" id="home">
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="/"><span>Mercado</span> <i>Shoes</i></a></h1>
				</div>
		...
		<div class="search_w3ls_agileinfo">
			...
			<div id="cd-search" class="cd-search">
				<form>
					<input name="Search" type="search" placeholder="Persiona Enter para buscar...">
				</form>
			</div>
		</div>
		<!-- //search -->
		...
		<div class="shop_inner_inf">
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				...
				<div class="description">
					<h5>Revisa entregas, formas de pago y cargos en tu ubicación</h5>
					<form>
						<input type="text" value="Ingresa Código Postal" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Ingresa Código Postal';}"
						    required="">
				...
				<div class="occasional">
					<h5>Tipos :</h5>
					<div class="colr ert">
						<label class="radio"><input type="radio" name="radio" checked=""><i></i>Casuales</label>
					</div>
					<div class="colr">
						<label class="radio"><input type="radio" name="radio"><i></i>Tenis </label>
					</div>
					<div class="colr">
						<label class="radio"><input type="radio" name="radio"><i></i>Formales</label>
					</div>
					<div class="clearfix"> </div>
				</div>
					...
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								...
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="/producto" class="link-product-add-cart">Vista Rápida</a>
									</div>
								</div>
							...
							<div class="item-info-product">
								<h4>
									<a href="/producto">Shuberry Heels </a>
								</h4>
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							...
							<div class="item-info-product">
								<h4>
									<a href="/producto">Running Shoes</a>
								</h4>
								<div class="info-product-price">
									<div class="grid_meta">
										<div class="product_price">
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							...
							<div class="item-info-product">
								<h4>
									<a href="/producto">Sukun Casuals</a>
								</h4>
								<div class="info-product-price">
									<div class="grid_meta">
										<div class="product_price">
	...
	<div class="footer_agileinfo_w3">
		<div class="footer_inner_info_w3ls_agileits">
			<div class="col-md-3 footer-left">
				<h2><a href="/"><span>M</span>ercado Shoes </a></h2>
					...
					<div class="col-md-5 sign-gd-two">
						...
						<div class="address">
							...
							<div class="address-grid">
								...
								<div class="address-right">
									<h6>Location</h6>
									<p>Calle Desconocido #234, Mérida, YUC, MX.</p>
								</div>
								<div class="clearfix"> </div>
							</div>
						</div>
			...
			<p class="copy-right-w3ls-agileits">&copy 2020 Mercado Shoes. All rights reserved | Design by <a href="http://w3layouts.com/">w3layouts</a></p>
		</div>
    </div>
